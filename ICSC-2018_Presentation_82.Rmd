...
# Scope 
<!-- {data-background="img/Wake_Up.gif" data-background-position="bottom" data-background-size="70%"}   -->
...
# Conclusions {data-background="img/2001_ending.gif"}
...
> - Through a fine-grained and cross-market analysis of the thematic organization of the corpus we were able to gain relevant information about drug
trade on ToR that goes well beyond those provided by the already available high level content classification.


#  {data-background="img/truman_show_end.gif"}
